...
// https://municvddb.ccbp.tech
// use testid instead of data-testid while submitting the code
// And use data-testid while publishing the code if u see testid is unknown in warnings ok
const statesList = [
  {
    state_code: 'AN',
...
class Home extends Component {
  ...
  renderCovidCasesData = () => {
    ...
    const updatedFilteredStates = filteredStatesList.map(state => ({
      stateCode: state.state_code,
      stateName: state.state_name,
    }))
